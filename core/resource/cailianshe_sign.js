...
function getsign(){
    var t = "app=CailianpressWeb&fields=secu_name,secu_code,trade_status,change,change_px,last_px&os=web&secu_codes=sh000001,sz399001,sh000905,sz399006&sv=7.5.5";
    var i = fff('KjvB');
    console.log(i.sync(t));
    var s = fff("aCH8");
    return s(i.sync(t));
}